...
def parse_args():
	...
	parser.add_argument('--graphNum', default=6, type=int, help='number of graphs based on time series')
	parser.add_argument('--decay', default=0.96, type=float, help='weight decay rate')
	parser.add_argument('--save_path', default='movie8', help='file name to save model and training record')
	parser.add_argument('--latdim', default=64, type=int, help='embedding size')
	parser.add_argument('--ssldim', default=48, type=int, help='user weight embedding size')
	...
	parser.add_argument('--testSize', default=1000, type=int, help='size for test')
	parser.add_argument('--sslNum', default=90, type=int, help='batch size for ssl')
	...
	parser.add_argument('--data', default='movielens', type=str, help='name of dataset')
	...
	parser.add_argument('--ssl_reg', default=1e-6, type=float, help='reg weight for ssl loss')
	...
	parser.add_argument('--lambda1', default=0.1, type=float, help='weight for long-term prediction loss')
	parser.add_argument('--pSdim', default=1024, type=int, help='user weight embedding size')
	parser.add_argument('--item_threshold', default=0.0, type=float, help='item threshold for item-item graph')
	parser.add_argument('--similarity_threshold', default=0.1, type=float, help='similarity threshold for item-item graph to add item-graph')
	parser.add_argument('--beta', default=0.5, type=float, help='attention to the outlier data')
